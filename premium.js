...
<div class="section">
  ...
  <ul>
    <li><strong>Окна бодрствования</strong> — практический ориентир, а не строгая медицинская норма</li>
    <li>Диапазоны сна зависят от возраста, но индивидуальная потребность различается</li>
    <li>Меняйте укладывание небольшими шагами по 10–15 минут и оценивайте 2–3 дня</li>
    <li>Ориентир температуры для сна: <strong>16–20°C</strong>; проверяйте грудь и шею малыша</li>
    <li>Белый шум включайте тихо, подальше от кроватки и лучше с таймером</li>
  </ul>
</div>

<div class="section">
  <h3>🌙 Возрастные ориентиры для настройки режима</h3>
  <table class="norms">
...
<div class="section">
  ...
  <ul>
    ...
    <li>При временном ухудшении сна сохраняйте знакомый ритуал и помогайте малышу привычным безопасным способом</li>
